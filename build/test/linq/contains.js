...
qtest('collections "contains" method tests', function (assert) {
    ...
    assert.ok(mx(dictionary).contains({ key: 1, value: 1 }, {
        hash: function (t) {
            return t.key;
        },
        equals: function (a, b) {
    ...
    assert.ok(!mx(map).contains({ key: 0, value: 0 }, {
        hash: function (t) {
            return t.key;
        },
        equals: function (a, b) {
    ...
    assert.ok(!mx(map).contains(0), 'Test does not contain in a Lookup');


    assert.ok(mx(sortedList).contains({ key: 1, value: 1 }, {
        hash: function (t) {
            return t.key;
        },
        equals: function (a, b) {
