(function (global, factory) {
    ...
    qtest('basic "contains" test', function (assert) {
        assert.ok(mx__default['default'](array).contains(1), 'Test an array contains a number');
        assert.ok(!mx__default['default'](array).contains(0), 'Test an array does not containy a number');
    });
    ...
    qtest('equalityComparer "contains" test', function (assert) {
        ...
        assert.ok(mx__default['default']([{ val: 1 }]).contains({ val: 1 }, comparer), 'Test an array of objects contains a value');
        assert.ok(!mx__default['default']([{ val: 1 }]).contains({ val: 2 }, comparer), 'Test an array of objects non containing a value');
    });
    ...
    qtest('hash/equals override "contains" test', function (assert) {
        ...
        assert.ok(mx__default['default']([new Basic(1, 'A'), new Basic(2, 'B')]).contains(new Basic(1, 'A')), 'Test an array of objects contains a value');
        assert.ok(!mx__default['default']([new Basic(1, 'A'), new Basic(2, 'B')]).contains(new Basic(1, 'B')), 'Test an array of objects non containing a value');
    });
