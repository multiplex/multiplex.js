(function (global, factory) {
    ...
    qtest('basic group-join test', function (assert) {
        assert.equal(mx__default['default'](array).groupJoin(array, identity, identity, identity).count(), array.length, 'Test groupJoin numbers in an array are less than 10');
    });
