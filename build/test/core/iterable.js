(function (global, factory) {
    ...
    var Iterable = mx__default['default'].Iterable;
    var Iterator = mx__default['default'].Iterator;
    ...
    qtest('from empty factory method', function (assert) {
        ...
        assert.equal(it[mx__default['default'].runtime.iteratorSymbol]().toString(), '[Empty Iterator]', 'empty Iterator toString');
    });
