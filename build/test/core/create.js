(function (global, factory) {
    ...
    function count(val) {
        var iterator = val[mx__default['default'].runtime.iteratorSymbol](),
            count = 0;
    ...
    qtest('from iterable function', function (assert) {
        var it = mx__default['default'](function () {
            var index = 0;
    ...
    qtest('from .Net Enumerable object', function (assert) {
        ...
        var it = mx__default['default'](obj);
        assert.equal(count(it), 3, 'Enumerable count');
        assert.deepEqual(toArray(it), [1, 2, 3], 'Enumerablen to array');
        assert.equal(mx__default['default'].iter(it).toString(), '[Enumerable Iterator]', 'Enumerable Iterator toString');
    ...
    qtest('from generator function', function (assert) {
        /*jshint evil:true*/
        try {
            var it = mx__default['default'](eval('(function*() { yield 1; })'));
    ...
    qtest('from map', function (assert) {
        if (typeof Map === 'function') {
            var val = [[{}, 1]];
            var it = mx__default['default'](new Map(val));
    ...
    qtest('from set', function (assert) {
        if (typeof Set === 'function') {
            var val = [{}];
            var it = mx__default['default'](new Set(val));
    ...
    qtest('from arguments', function (assert) {
        var it = mx__default['default'](arguments);
    ...
    qtest('from array-like object', function (assert) {
        ...
        var it = mx__default['default'](val);
        ...
        assert.equal(it[mx__default['default'].runtime.iteratorSymbol]().toString(), '[Array Iterator]', 'array-like Iterator toString');

        if (typeof Int8Array === 'function') {
            var arr = mx__default['default'](new Int8Array([1]));
    ...
    qtest('from iterable object', function (assert) {
        ...
        val[mx__default['default'].runtime.iteratorSymbol] = function () {
            var index = 0;
            return {
                next: function () {
                    if (index < 1) {
    ...
    qtest('from object', function (assert) {
        var it = mx__default['default']({ val: 1 });
        ...
        assert.equal(it[mx__default['default'].runtime.iteratorSymbol]().toString(), '[Object Iterator]', 'object Iterator toString');
    });
    ...
    qtest('from null value', function (assert) {
        var it = mx__default['default'](null);
        ...
        assert.equal(it[mx__default['default'].runtime.iteratorSymbol]().toString(), '[Empty Iterator]', 'empty(null) Iterator toString');
    });


    qtest('from undefined value', function (assert) {
        var it = mx__default['default']();
        ...
        assert.equal(it[mx__default['default'].runtime.iteratorSymbol]().toString(), '[Empty Iterator]', 'empty(undefined) Iterator toString');
    });
