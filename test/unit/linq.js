...
(function () {
    ...
    function CreateSimpleClassArray() {
        return mx.range(0, 10).select(function () {
    ...
    function CreateSimpleClassWithComparerArray() {
        return mx.range(0, 10).select(function (t) {
            return new SimpleClassWithComparer(t);
        }).toArray();
    }
    ...
    function CreateFloatNumberArray() {
        return mx.range(0, 10).select(function (t) {
            return t + 0.1;
        }).toArray();
    }
    ...
    QUnit.test("contains", function (assert) {
        ...
        assert.ok(mx(_arr2).contains(new SimpleClass(), {
    ...
    QUnit.test("forEach", function (assert) {
        ...
        mx(_arr).forEach(function (t) { _sum += t; });
    ...
    QUnit.test("orderBy", function (assert) {
        ...
        assert.ok(mx(_arr2).orderBy("t => t.name", {
            hash: function (o) { return mx.hash(o); },
    ...
    QUnit.test("sum", function (assert) {
        ...
        assert.throws(function () {
            mx(CreateComplexObjectLiteralArray()).sum("t => t.name");
