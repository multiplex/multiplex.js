...
(function () {
    ...
    function CreateObjectHashSet() {
        ...
        return new HashSet(_items, _comparer);
    }
    ...
    QUnit.test("comparer", function (assert) {
        ...
        assert.ok(_hash2.comparer().equals({ name: "A", val: 1 }, { name: "A", vale: 2 }), "HashSet custom comparer!");
    });
    ...
    QUnit.test("exceptWith", function (assert) {
        ...
        assert.ok(_hash2.count() === 1 && _hash2.contains({ name: "A" }) === false, "HashSet of objects except a collection, get count!");
    ...
    QUnit.test("intersectWith", function (assert) {
        ...
        assert.ok(_hash2.count() === 1 && _hash2.contains({ name: "A" }) === true, "HashSet of objects intersect with a collection, get count!");
    ...
    QUnit.test("isProperSubsetOf", function (assert) {
        ...
        assert.ok(new HashSet().isProperSubsetOf([1, 2, 3]) === true, "an empty set is a proper subset of any other collection!");
        assert.ok(new HashSet().isProperSubsetOf([]) === false, "an empty set is not a proper subset of another empty collection!");
    ...
    QUnit.test("isProperSupersetOf", function (assert) {
        ...
        assert.ok(new HashSet().isProperSupersetOf([1, 2, 3]) === false, "an empty set is a not superset of any other collection!");
        assert.ok(new HashSet().isProperSupersetOf([]) === false, "an empty set is not a proper superset of another empty collection!");
    ...
    QUnit.test("isSubsetOf", function (assert) {
        ...
        assert.ok(new HashSet().isSubsetOf([1, 2, 3]) === true, "an empty set is a subset of any other collection!");
        assert.ok(new HashSet().isSubsetOf([]) === true, "an empty set is a subset of another empty collection!");
    ...
    QUnit.test("isSupersetOf", function (assert) {
        ...
        assert.ok(new HashSet().isSupersetOf([1, 2, 3]) === false, "an empty set is a not superset of any other collection!");
        assert.ok(new HashSet().isSupersetOf([]) === true, "an empty set is superset of another empty collection!");
    ...
    QUnit.test("overlaps", function (assert) {
        ...
        assert.ok(_hash2.overlaps([{ name: "A" }]) === true, "HashSet of objects overlaps with another collection!");
    ...
    QUnit.test("setEquals", function (assert) {
        ...
        assert.ok(new HashSet().setEquals([]) === true, "an empty HashSet equals with an empty collection!");
        assert.ok(new HashSet().setEquals([1, 2, 3]) === false, "an empty HashSet does not equals with another collection!");
    });
    ...
    QUnit.test("symmetricExceptWith", function (assert) {
        ...
        _hash2.symmetricExceptWith([{ name: "A" }]);
        _hash3.exceptWith(CreateNumericHashSet());
        ...
        assert.ok(_hash2.contains({ name: "A" }) === false && _hash2.contains({ name: "B" }) === true, "HashSet of objects symmetric except another collection, check contains!");
    ...
    QUnit.test("unionWith", function (assert) {
        ...
        assert.ok(_hash2.contains({ name: "A" }) === true && _hash2.contains({ name: "D" }) === true, "HashSet of objects union with another collection, check contains!");
