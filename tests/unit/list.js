...
(function () {
    ...
    QUnit.test("constructor", function (assert) {
        ...
        assert.ok(new List(Enumerable.range(0, 10)).count() == 10, "List from an Enumerable!");
    });
    ...
    QUnit.test("addRange", function (assert) {
        ...
        _list.addRange(Enumerable.range(0, 10));
    ...
    QUnit.test("asReadOnly", function (assert) {
        ...
        var _rlist = new List(Enumerable.range(0, 10)).asReadOnly();
    ...
    QUnit.test("binarySearch", function (assert) {
        ...
        var _list1 = new List(Enumerable.range(0, 100));
        var _list2 = new List(Enumerable.range(0, 100).select("t => { index: t }"));
    ...
    QUnit.test("insertRange", function (assert) {
        ...
        _list.insertRange(3, Enumerable.range(0, 3));
        ...
        assert.throws(function () {
            _list.insertRange(10, Enumerable.range(0, 3));
